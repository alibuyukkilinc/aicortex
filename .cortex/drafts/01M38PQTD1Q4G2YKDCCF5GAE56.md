...
reason: "Gözden geçirme: ekler, eskime dereceleri, 20 MCP aracı, yeni repo
  belgeleri (CHANGELOG/CONTRIBUTING/SECURITY) ve 0.2.0 durumu eklendi; geri
  kalanı koda göre hâlâ doğru."
base_rev: e55fde5d
id: 01M38PQTD1Q4G2YKDCCF5GAE56
proposed_at: 2026-09-24T03:18:25.441Z
data:
  path: ""
  title: Cortex
  summary: İnsan ve AI için ortak proje beyni. Bilgi ağacı, pano, kararlar,
    ...
    proje için yerel çalışır; ekip için bir sunucu (hub) çok projeyi, kişileri,
    AI ajanlarını ve rolleri yönetir. Hiç LLM çağırmaz.
  links:
    code:
  ...
  status: active
  updated_by: ai-agent
  updated_at: 2026-09-24T03:18:25.437Z
---
