...
reason: "Gözden geçirme: S8-S11 ve eklerde bulunan tuzaklar (biçim tespiti,
  TS7/lint, Fastify ayrıştırıcı, DOMPurify blob, Escape yığını, taslak
  zamanlaması) eklendi."
base_rev: 26f239f8
id: 01M38PY6FMPMFBSYX6YW73YPJX
proposed_at: 2026-09-24T03:21:54.420Z
data:
  ...
  summary: "node:sqlite: FTS5 ancak Node 22.16'dan itibaren; numaralı parametre
    yok. git Türkçe yolları tırnaklar, macOS NFD verir. typescript-eslint TS
    7'yi desteklemez. DOMPurify blob: adreslerini atar. Fastify JSON
    ayrıştırıcısı ham yüklemede engel. Windows'ta git çağrısı ~20-45 ms."
  links:
    code:
  ...
  status: active
  updated_by: ai-agent
  updated_at: 2026-09-24T03:21:54.410Z
---
