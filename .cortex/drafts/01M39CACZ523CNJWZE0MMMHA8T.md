...
reason: 3e3415a package.json'da yalnızca sürümü 0.2.2 yaptı; yayın akışı (v*.*.*
  etiketi → CI → npm provenance) aynı ve bu sürümle doğrulandı.
base_rev: "67215743"
id: 01M39CACZ523CNJWZE0MMMHA8T
proposed_at: 2026-09-24T09:35:34.373Z
data:
  path: server
  title: Çalıştırma, derleme ve yayın
  summary: "Tek proje yerelde çalışır: `cortexboard start` 127.0.0.1:4747. Derleme
    = tsc + vite, çıktı dist/. CI: 3 işletim sistemi × Node 22.16 ve 24, lint
    bir ayakta. Yayın: v*.*.* etiketi CI'ı çalıştırıp npm'e provenance ile
    yükler. Paket adı `cortexboard`."
  links:
    code:
      - file: package.json
      - file: tsconfig.json
  ...
  verified_at_commit: 3e3415a81f7689f7b72fa2f93d1b0790f9021114
  id: 01M34Q1CBEMJA6S58G199HVFBQ
  status: active
  updated_by: ai-agent
  updated_at: 2026-09-24T09:35:34.368Z
---
