...
reason: "`--dir`/CORTEX_DIR tüm proje komutlarına eklendi (Claude Desktop ve
  Codex için) ve kurulum rehberleri yazıldı."
base_rev: 26b1ea25
id: 01M38QFCCSFP6ADJG0DJT8K7VD
proposed_at: 2026-09-24T03:31:17.529Z
data:
  path: backend/cli
  ...
  summary: "`aicortex` (kısa adı `cortex`) komutları: init, start, login, logout,
    ...
    init | start | add-project | invite. Her proje komutu `--dir` ya da
  ...
  verified_at_commit: 081627b7998a5f8142977d035eb6c7e7a3ff11ee
  id: 01M34QY9W1VNPQMRXK141RRDFS
  status: active
  updated_by: ai-agent
  updated_at: 2026-09-24T03:31:17.528Z
---
