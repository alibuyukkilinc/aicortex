---
kind: node
target: backend/index-search
proposed_by: ai-agent
reason: "Gözden geçirme: INDEX_VERSION 7 ve kart sütunları, open_work, SQL
  görünürlüğü (S6), NFC (S7), ItemStore haritası; eski metin retermItems'in
  yalnızca terminal'i güncellediğini söylüyordu."
base_rev: ef215912
id: 01M38PSF0CB33SHM0YG6R1D49J
proposed_at: 2026-09-24T03:19:19.308Z
data:
  path: backend/index-search
  title: İndeks ve kelime araması
  summary: "node:sqlite önbelleği; düğümler, kalemler ve aktivite üzerinde FTS5
    kelime araması. Türkçe harfler katlanır. İndeks artımlı güncellenir
    (yalnızca değişen kayıt). Kalem satırı panonun kartını da taşır: açık iş, ek
    sayısı, kapak, öncelik, son tarih."
  links:
    code:
  ...
  status: active
  updated_by: ai-agent
  updated_at: 2026-09-24T03:19:19.296Z
---
