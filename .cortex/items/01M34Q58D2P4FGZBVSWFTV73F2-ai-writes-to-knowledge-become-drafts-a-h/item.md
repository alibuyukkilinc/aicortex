...
author: ai-agent
fields:
  context: Projenin 'bildiği' şeyin kontrolü insanda kalmalı; AI kendinden emin
    şekilde yanılabilir.
  alternatives: Her şey auto (hızlı ama kontrol yok) ya da her şey review (güvenli
    ama görev ve sorular için çok yavaş).
