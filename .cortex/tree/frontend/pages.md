...
- Bilgi: ağaç, markdown, kod bağlantıları; eskimiş düğümde "Hâlâ doğru" ve "Düzenle" düğmeleri; kök dışındaki düğümlerde "Sil" (sunucu reddederse nedeni gösterilir).
...
- Raporlar: özet kutuları, grafikler, listeler, markdown kopyala/indir. Kurallar: YAML düzenleyici, geçersiz kural kaydedilmez.
